...
namespace VideoCoding
{
	...
	using namespace cv;
	class ThirdVideoEnc : public virtual StageCoding
	{
		public:
			ThirdVideoEnc(string ifname, string ofname, char mode, uint predictMode=6, uint blockSize=8, uint searchArea=4, uint periodicity=15, char thresholdMode='r', double t=1., double base_threshold=12., double ceil_threshold=4., double min_threshold=40., char searchMode='s');
			~ThirdVideoEnc();
